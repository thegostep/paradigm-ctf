...
contract CompDaiFarmer {
    ...
    function redeemUnderlying(uint256 amount) public {
        require(
            msg.sender == owner || amount <= deposits[msg.sender],
            "cannot redeem more than your balance"
        );
    ...
    function recycle() public returns (uint256) {
        ...
        uint256[] memory amts =
            router.swapExactTokensForTokens(bal, 0, path, address(this), block.timestamp + 1800);
